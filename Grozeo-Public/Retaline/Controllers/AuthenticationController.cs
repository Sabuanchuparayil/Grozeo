...
namespace Retaline.Web.Controllers
{
    public class AuthenticationController : Controller
    {
        ...
        public async Task<IActionResult> UpdateVerifiedStatus(string verified)
        {
            var user = _authenticationService.GetUserFromClaims();
            // Update the curUser object based on the emailVerified parameter
            if(verified == "email")
            {
            ...
            // Optionally, save the updated curUser object to a database or session
        ...
        public async Task<IActionResult> UpdateAgeVerifiedStatus(bool value)
        {
            var user = _authenticationService.GetUserFromClaims();
            // Update the curUser object based on the Age verified parameter
            if (value)
            {
                user.AgeVerified = 1;
            }
