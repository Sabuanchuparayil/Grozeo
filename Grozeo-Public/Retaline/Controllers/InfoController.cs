...
namespace Retaline.Web.Controllers
{
    public class InfoController : Controller
    {
        ...
        {
            var page = await _pageService.GetPage(2);
            return View(page);
        }
        ...
        {
            var page = await _pageService.GetPage(3);
            return View(page);
        ...
        {
            var page = await _pageService.GetPage(1);
            return View(page);
        }
        [Route("about-us-mini")]
        public async Task<IActionResult> AboutMin()
        {
            try
            {
                var page = await _pageService.GetPage(1);
        ...
        {
            var page = await _pageService.GetPage(4);
            return View(page);
        }
        [Route("return-refund-policy")]
        public async Task<IActionResult> ReturnRefundPolicy()
        {
            var page = await _pageService.GetPage(6);
            return View(page);
        }
        [Route("faq")]
