...
namespace Retaline.Web.Controllers
{
    ...
    public class MyAccountController : Controller
    {
        ...
        public async Task<IActionResult> WishList()
        {
            ...
            {
                return Json(new { status = 0, message = "An error occurred. Please try again."});
            }
        ...
        public async Task<IActionResult> ReturnItems([FromBody] List<OrderItem> orderItems)
        {
            try
            {
                ...
                return Json(new { status = 0, message = "An error occurred. Please try again.", content = "An error occurred. Please try again." });
            }
        }
