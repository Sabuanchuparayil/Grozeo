...
namespace Retaline.Web
{
	public class Startup
	{
		...
		public void ConfigureServices(IServiceCollection services)
		{
            ...
            services.AddHttpClient("GrozeoApi", client =>
            {
		...
		public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
		{
            ...
            // Allow known proxy IP (optional but recommended)
            options.KnownNetworks.Clear(); // Or add specific Front Door IP ranges
            options.KnownProxies.Clear();

            app.UseForwardedHeaders(options);
            app.UseMiddleware<Retaline.Web.Framework.SecurityHeadersMiddleware>();
			...
			app.UseStaticFiles(new StaticFileOptions
			{
				OnPrepareResponse = ctx =>
				{
					...
					if (contentType.Contains("css") || contentType.Contains("javascript") ||
