...
class TextLocalSms implements SmsProviderInterFace {
    ...
    public function sendSms($mobile, $msg, $templid = 0) {
        ...
        if (config('sms.pocketkart_sms_provider') == 'true') {
            $url = "http://sms.bulksmsind.in/sendSMS?username=codefacetech&message=" . urlencode($msg) . "&sendername=PTKART&smstype=TRANS&numbers=" . $mobile . "&apikey=9b794001-fc6a-47e9-8163-7d0144d85573";
