...
class ScheduleNewBookings
{
    ...
    {
        QugeoOrder::whereRaw("(quor_id = {$orderID}) OR (quor_PickupPincode = {$book->PickupPincode} AND quor_PickupToBeManual = 0 AND quor_ScheduleOpeningTime BETWEEN {$now} AND {$endTime})")->update([
