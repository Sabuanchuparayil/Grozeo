        ...
        try
        {
            ...
            if($request)
            {
                ...
                if($response->status == "Success")
                {
                    ...
                    {
                        $qry = "CALL insertSettlementData('".json_encode($param['orderDetails'])."', {$param['amount_due']}, {$param['sale_proceeds']}, {$param['expenses']}, {$param['refunds']}, {$param['storegroup']}, {$param['BranchId']}, {$param['BankId']}, '{$param['BankAccountNo']}', '{$param['IFSC']}', '{$param['uuid']}', '{$param['AccountName']}', '{$param['StoreEmail']}', {$param['PgType']}, '{$param['PgAccountId']}')";
                        $resp[] = DB::select($qry);
                    }
                }
            }
