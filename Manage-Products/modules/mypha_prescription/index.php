...
switch ($op) {
    ...
    case 'mapPrescriptionMedicine':
        ...
        break;
    case 'postMedicines':
        $orderItems = $db->getMultipleData("SELECT stit_ID,stit_SKU  FROM finascop_stock_itemmaster WHERE isMedicine = 1 AND stit_status = 1 AND  stit_SKU LIKE '%{$_POST['medicineName']}%'", true);
