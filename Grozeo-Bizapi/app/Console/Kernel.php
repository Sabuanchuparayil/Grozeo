...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule)
    {
       ...
       $schedule->call(new AssignOrder)->name('AssignOrder')->withoutOverlapping();
        ...
        // Failed job monitoring — runs hourly, prunes jobs older than 7 days
        $schedule->command('queue:monitor-failed --prune=168')->hourly();

        // Restart queue workers to pick up code changes after deployments
