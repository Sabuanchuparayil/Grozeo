...
class ProductController extends Controller
{
    ...
    {
        $domain = "https://" . config('filesystems.disks.s3.bucket') . "." . config('filesystems.disk4s.s3.driver') . ".".config('filesystems.disks.s3.region', 'ap-southeast-1').".amazonaws.com/products/";
        $domain = (config('app.cdn_url') != "") ? (config('app.cdn_url')."/products/") : $domain;
