...
class UploadPrescriptionController extends Controller
{
    ...
    public function getdiscription(Request $request)
    {
        ...
        $domain = "https://" . config('filesystems.disks.s3.bucket') . "." . config('filesystems.disks.s3.driver') . ".".config('filesystems.disks.s3.region', 'ap-southeast-1').".amazonaws.com/prescription/";
