    ...
    public function _getCreditAgeReportGridData($postvar) {
        ...
        if (isset($_POST['filter']) && $_POST['filter'] != '') {
            foreach ($_POST['filter'] as $key => $v) {
                $_allowedFilterFields = ['bbso_id', 'b2b_Customer_Name', 'bbso_SONumber', 'bbso_SODate', 'bbso_SOValue', 'bbso_validDate', 'bbso_InvNumber', 'bbso_InvDate', 'delayDay'];
...
FROM finascop_stock_party_items";
    ...
    public function _getB2BCustomersReportGridData($postvar) {
        ...
        $listQuery = "SELECT b2b_Customer_ID,b2b_Customer_Name,CONCAT(br_Name ,'-',branch_shortname) as br_Name,"
