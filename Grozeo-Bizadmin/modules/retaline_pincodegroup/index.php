...
//--
    ...
    case 'listPincodeGroupTimeSlotStore':
        ...
        if (isset($_POST['filter']) && $_POST['filter'] != '') {
            foreach ($_POST['filter'] as $key => $v) {
                ...
                if (!isset($fields) || !array_key_exists($v['field'], $fields)) continue;
    ...
    case 'deleteBranchTimeSlot':
        ...
        $safe_rbds_id = (int)($_POST['rbds_id'] ?? 0);
        $del_query = "DELETE FROM retaline_branch_delivery_slot WHERE rbds_id ='{$safe_rbds_id}'";
